...
df = pd.read_csv(df_url, index_col= 0, header = 0)
...
df_desc = pd.read_csv(df_desc_url, index_col = 0, header = 0)
...
df_images = pd.read_csv(df_images_url, index_col = 0, error_bad_lines=False, header = 0)
