...
df = pd.read_csv(df_url, index_col= 0, header = 0, sep = ',')
...
df_desc = pd.read_csv(df_desc_url, index_col = 0, header = 0, sep = ',')
...
df_images = pd.read_csv(df_images_url, index_col = 0, header = 0, sep = ',')
